...
insert into tb_categoria (descricao) values ("Higiene Pessoal");
insert into tb_categoria (descricao) values ("Doces");
insert into tb_categoria (descricao) values ("Bebês");
insert into tb_categoria (descricao) values ("Medicamentos");
